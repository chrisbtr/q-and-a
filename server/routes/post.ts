    ...
    */
    async (req: Request, res: Response) => {
        try {
            ...
            const { title, subject, categoryCode, questionContent, answerContent, userData } = req.body;
            const date = new Date();
            ...
            const newAnswer = await prisma.answers.create({
                data: { content: answerContent, createdAt: date, questionId: newQuestion.id, userId: userData.userId },
            });
